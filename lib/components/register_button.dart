...
class askCodeDialog extends StatefulWidget {
  ...
  const askCodeDialog(
      {super.key, required this.onSaved, required this.globalKey});
    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(RegisterLoginTextsTr.codeQuestion,
                style: LoginRegisterStyle.dialogTextStyle),
            Padding(
