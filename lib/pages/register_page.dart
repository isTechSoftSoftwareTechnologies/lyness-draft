...
import 'package:lyness/components/customTextFormField.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  bool isVisible = true;
  List<DropdownMenuItem> citySelection = trCities.cityList
                      ...
                      children: [
                        ...
                        registerButton(
                          onPressed: () {
                            ...
                            print(
                                '_formGlobalKey.currentState!.validate(): ${_formGlobalKey.currentState!.validate()}');
                            if (_canClickButton) {
                              showDialog(
                                context: context,
                                builder: (context) {
